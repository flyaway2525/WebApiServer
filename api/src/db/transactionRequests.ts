...
import {
  ...
  insertTransactionRequestEntry,
  listTransactionRequestsBySpaceId,
  resolveTransactionRequest
} from './lookups.js';
import {
  assertTransactionRequestPermission,
  canResolveTransactionRequest,
  validateReferencedMembers
...
export async function listSpaceTransactionRequests(spaceId: number): Promise<SpaceTransactionRequestRecord[]> {
  return listTransactionRequestsBySpaceId(spaceId);
}

export async function createSpaceTransactionRequest(
  spaceId: number,
  input: CreateSpaceTransactionRequestInput,
